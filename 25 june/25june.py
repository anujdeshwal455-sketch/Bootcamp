...
b2 = Book(1234567891234, "The Book of Mindless", "anuj chaudhary", 1)

# print(b1.__copies)

print(b1._Book__isbn)  
print(b1.isbn) 
print(b1._title)
print(b1._author)
print(b1._Book__copies)
print(b1.copies)
...
atm = ATM(123690, 5000, "anuj chaudhary")
...
# class aniaml:
#     def__init__(self, name, sound):
#         self.name =name 
#         self.sound =sound
# def speak(self):
#     returnf"{self.name} says {self.sound}!"
#     def
